...
export function LaunchBuilder() {
  ...
  async function saveDraft() {
    ...
    try {
      ...
      const body = (await response.json()) as { error?: string; imageStored?: boolean };
