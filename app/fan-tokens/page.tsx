  ...
  return (
    <SiteChrome>
      <main className="page-wrap inner-page">
        <PageIntro kicker="Official Fan Token addresses" title="Explore current Chiliz V2 contracts and two Solana options." copy="Chiliz migrated Fan Tokens to new 18-decimal contracts in 2026. The older Kayen wrapped-token catalog points to legacy contracts and does not establish a route to the current tokens. Chiliz rewards, claims, and new mainnet launches remain paused.">
        ...
        <SafetyNotice>The Chiliz addresses shown here are the official V2 Fan Token contracts, not SportPad copies. Historical Kayen wrappers represent older token contracts. SportPad will not purchase those legacy wrappers or promise a Chiliz payout until a direct V2 acquisition and transfer route passes end-to-end verification.</SafetyNotice>
        ...
        <section className="content-section">
          ...
          <div className="registry-table-wrap">
            <table className="registry-table"><thead><tr><th>Official Fan Token</th><th>Sport</th><th>Current token address</th><th>Network</th><th>Route</th><th>Status</th></tr></thead><tbody>
