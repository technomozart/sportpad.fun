  ...
  return (
    <SiteChrome>
      <main className="page-wrap inner-page">
        <PageIntro kicker="Official Fan Token registry" title="Choose from the official Chiliz Solana-address registry." copy={`This snapshot lists the ${fanAssets.length} Fan Tokens with Solana addresses in the official Chiliz multi-chain contract registry. A separate section identifies 14 additional assets found in the FanTokens.com catalog that do not currently have a Solana address in that registry.`}>
        ...
        <SafetyNotice>These reward assets are official Fan Tokens issued for the named sports organizations. SportPad verifies each exact Solana mint against the official registry.</SafetyNotice>
        ...
        <section className="content-section">
          ...
          <div className="registry-table-wrap">
            <table className="registry-table"><thead><tr><th>Official Fan Token</th><th>Sport</th><th>Official Solana mint</th><th>Identity</th><th>Route</th><th>Vault</th></tr></thead><tbody>
