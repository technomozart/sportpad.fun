  ...
  return (
    <SiteChrome>
      <main className="page-wrap inner-page">
        ...
        <SafetyNotice>The named reward assets are official Fan Tokens rooted in the Chiliz ecosystem. Each published launch records the selected network and exact token contract. Market and reward figures are withheld unless a verifiable source is available.</SafetyNotice>
